...
public class AstarSearchAlgo{
        ...
        public static void main(String[] args){
                ...
                List<Node> path = printPath(n13);
                        ...
                        System.out.println("A* Path:"+path.toString()+"\n");
                        
                Greedy_BFS.Greedy_BFS(n1, n13);
                        path = Greedy_BFS.GreedyprintPath(n13);
                        System.out.println("Greedy Best-First Search Path:"+path.toString());
